...
function Add() {
    ...
    document.title = "Have.It- Manage | Users";
    ...
    const validation = useFormik({
        ...
        onSubmit: async (values) => {
            ...
            // save new TeamData
            const response = await dispatch(onAddUserData(values));
    ...
    return (
        ...
        <div className='page-content'>
            <Container fluid>
                <BreadCrumb title="Add" pageTitle="Article" />
                    ...
                    <Col lg={6}>
                        <Form className="tablelist-form" onSubmit={(e) => {
                                ...
                                <Row className="g-3 mt-5">
                                    ...
                                    <Col lg={12}>
                                        <div className="mb-1">
                                            ...
                                            <Input type="textarea" className="form-control" id="content" placeholder="Enter content..." name='content'
                                            rows={4} cols={40}
                                                validate={{
                                                    required: { value: true },
                                                }}
                            ...
                            <div className="hstack gap-2 justify-content-end">
                                ...
                                <button type="submit" className="btn btn-success" id="add-btn" > <i className="ri-add-fill me-1 align-bottom"></i> Publish </button>
                            </div>
                        </Form>
                    </Col>
                </div>
